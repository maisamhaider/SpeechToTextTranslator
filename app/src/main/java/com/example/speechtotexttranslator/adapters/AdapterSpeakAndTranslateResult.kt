...
class AdapterSpeakAndTranslateResult(
    private val context: Context,
    private val viewModel: ViewModelSpeakAndTranslateResult,
) : ListAdapter<ModelSpeakAndTranslateResult, AdapterSpeakAndTranslateResult.Holder>(MyDiffUtil()) {

    class MyDiffUtil : DiffUtil.ItemCallback<ModelSpeakAndTranslateResult>() {
        override fun areItemsTheSame(
            oldItem: ModelSpeakAndTranslateResult,
            newItem: ModelSpeakAndTranslateResult
        ): Boolean {
